          ...
          <div className="space-y-3">
            {factChecks.map((factCheck) => {
              ...
              return (
                ...
                >
                  <span
                    className={`absolute right-2 top-2 inline-flex items-center gap-1 px-2 py-[2px] font-mono text-[10px] font-bold uppercase tracking-[0.12em] ${
                  ...
                  <p className="pr-24 font-mono text-xs font-bold leading-relaxed text-ink">
                    CLAIM: {factCheck.claim}
                  </p>
                  <p className="mt-3 border-t border-ink/20 pt-2 font-mono text-[10px] uppercase leading-relaxed tracking-[0.1em] text-ink/70">
                    SOURCE:{' '}
