...
export function PhilosopherSelect({
  ...
  return (
    <section>
      <p className="mb-3 font-mono text-xs font-bold uppercase tracking-[0.14em] text-ink sm:tracking-[0.2em]">
        SELECT OPPONENT
      </p>
        ...
        {PHILOSOPHERS.map((philosopher) => {
          ...
          return (
            <button
              ...
              className={`flex min-h-11 w-full items-start gap-3 border-[3px] px-3 py-3 text-left shadow-brutal transition-all duration-100 hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-[2px_2px_0_0_#1A1A1A] active:translate-x-1 active:translate-y-1 active:shadow-none sm:px-4 ${
                isSelected
            ...
            >
              ...
              <div className="min-w-0">
                <p className="wrap-break-word font-mono text-xs font-bold uppercase tracking-[0.08em] sm:tracking-[0.16em]">
                  {meta.primary}
                </p>
